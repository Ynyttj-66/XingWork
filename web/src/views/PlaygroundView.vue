  ...
  doc_reader: {
    ...
    doneOutput: JSON.stringify({
      ...
      data: {
        ...
        table_count: 3,
        paragraphs: [
          { index: 0, number: 1, text: 'XingWork 产品需求文档', style: 'Title' },
          ...
          { index: 4, number: 5, text: 'XingWork 是一款基于大语言模型的智能对话助手，支持多工具调用、流式输出和长期记忆。', style: 'Normal' },
